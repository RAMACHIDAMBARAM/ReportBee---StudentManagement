...
<br>
 ...
 <label style="padding-left: 150px"  for="schoo_name" >School:</label>
   ...
   ?>
		...
		<label style="padding-left: 50px" for="standard" onChange="getgender(this.value);" >Standard:</label>
		...
		<label style="padding-left: 50px" for="gender" >Gender:</label>
...
if(isset($_POST['submit']))
{
	...
	$gender=($_POST['gender']);
	$query = "SELECT * From student where school_id= '".$school_name."' and standard_id = '".$standard."' and gender = '".$gender."'order by name" ;
	$sql = mysql_query($query);
	$query1 = "SELECT COUNT(*) AS total FROM student where school_id= '".$school_name."' and standard_id = '".$standard."' and gender = '".$gender."'";
    $res = mysql_query($query1);
    $row = mysql_fetch_assoc($res);
	?>
	  <?php

	   echo "<center> No.of ".$gender." students in school ID ".$school_name." at standard ID ".$standard." equal =  ". $row['total']." </center>";
	  echo "<br>
	  <table border='1'>
<tr>
<th>NAME</th>
